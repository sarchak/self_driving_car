...
weight_layers = {'layer0': 3, 'layer1': 32, 'layer2':64, 'layer3': 96, 'fc1': 512, 'fc2': 512, 'fc3': 64}
biases_layers = {'layer0': 3, 'layer1': 32, 'layer2':64, 'layer3': 96, 'fc1': 512, 'fc2': 512, 'fc3': 64}
...
def conv_net(x, keep_prob):
    ...
    W_fc1 = weight_variable([4 * 4 * weight_layers['layer3'], weight_layers['fc1']])
    b_fc1 = bias_variable([biases_layers['fc1']])
    ...
    W_fc2 = weight_variable([weight_layers['fc1'], weight_layers['fc2']])
    b_fc2 = bias_variable([biases_layers['fc2']])

    fc2 = tf.matmul(h_fc1_drop, W_fc2) + b_fc2
    h_fc2_drop = tf.nn.dropout(fc2, keep_prob)
    
    W_fc3 = weight_variable([weight_layers['fc2'], 43])
